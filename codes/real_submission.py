"""
Code to create a submission file (.txt) with the chosen model (here it is
RandomForestClassifier(n_estimators=3100, bootstrap=True,
                                 max_depth= None,
                                 class_weight='balanced_subsample', n_jobs=-1))
The basis of this code is the toy_submission.py given at the begging of the
project
...
#    Build the model
    model=RandomForestClassifier(n_estimators=3100, bootstrap=True,
                                 max_depth= None,
                                 class_weight='balanced_subsample', n_jobs=-1)
...
#    PREDICTION
    ...
    fname = make_submission(y_pred, auc_predicted, 'submission_RFC')
